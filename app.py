...
st.markdown("Source of the dataset: [Click Here](https://www.kaggle.com/datasets/saurabhshahane/road-traffic-accidents)")
...
st.markdown("Please find GitHub repository link of project: [Click Here](https://github.com/Beloved-vince/RTA_prediction_system)")                  
